                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('produk.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="smv" name="smv" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                            <label for="target_produksi_harian" class="block text-gray-700 text-sm font-bold mb-2">Target Produksi Harian:</label>
                            <input type="text" id="target_produksi_harian" name="target_produksi_harian" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
